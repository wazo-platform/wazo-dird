...
class _PersonalService:
    ...
    def __init__(self, config, source_manager, crud: database.PersonalContactCRUD, controller):
        self._crud = crud
        self._config = config
    ...
    def create_contacts(self, contact_infos, user_uuid, tenant_uuid):
        ...
        return (self._crud.create_personal_contacts(tenant_uuid, user_uuid, to_add), errors)
    ...
    def edit_contact(self, contact_id, contact_infos, user_uuid, tenant_uuid):
        self.validate_contact(contact_infos)
        return self._crud.edit_personal_contact(tenant_uuid, user_uuid, contact_id, contact_infos)
