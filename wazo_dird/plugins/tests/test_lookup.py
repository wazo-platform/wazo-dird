...
from wazo_dird.plugins.lookup import LookupServicePlugin
from wazo_dird.plugins.lookup import _LookupService
...
class TestLookupServicePlugin(unittest.TestCase):
    ...
    @patch('wazo_dird.plugins.lookup._LookupService')
...
class TestLookupService(unittest.TestCase):
    ...
    @patch('wazo_dird.plugins.lookup.ThreadPoolExecutor')
