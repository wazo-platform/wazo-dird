...
from wazo_dird.plugins.reverse_service import ReverseServicePlugin
from wazo_dird.plugins.reverse_service import _ReverseService
...
class TestReverseServicePlugin(unittest.TestCase):
    ...
    @patch('wazo_dird.plugins.reverse_service._ReverseService')
...
class TestReverseService(unittest.TestCase):
    ...
    @patch('wazo_dird.plugins.reverse_service.ThreadPoolExecutor')
